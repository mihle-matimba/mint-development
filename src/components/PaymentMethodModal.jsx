            ...
            <div className="max-h-[70vh] overflow-y-auto">
              ...
              <div className="px-5 pb-5 space-y-2.5 pt-3">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-4 rounded-2xl border-2 border-slate-200 bg-white px-4 py-3.5 text-left transition active:scale-[0.98] hover:border-[#00b0f0]/40 hover:bg-[#00b0f0]/5"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-slate-100 shadow-sm flex-shrink-0 p-1.5">
                    <img
                      src="/ozow-logo.png"
                  ...
                  <span className="text-[11px] font-semibold rounded-full px-2 py-0.5 flex-shrink-0 text-[#00b0f0] bg-[#00b0f0]/10">
                    Instant EFT
                  </span>
                </button>
